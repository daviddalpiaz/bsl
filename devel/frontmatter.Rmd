...
- Why not (insert model here)?
    - The idea behind this book is that after learnign this material, you won't need (insert model here) presented to you in great detail. Instead, you'll be able to find an implimentation of it in your langauage of choice, use it, adn evaluate if it is appropriate.
