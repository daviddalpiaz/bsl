...
## define data generating processs
gen_sim_data = function(f, sample_size = 100, x_min = -1, x_max = 1, sigma = 1) {
...
## simualte training data
set.seed(42)
sim_trn_data = gen_sim_data(f = f, sample_size = 100, x_min = x_min, x_max = x_max, sigma = 0.25)

## simulate testing data
set.seed(3)
sim_tst_data = gen_sim_data(f = f, sample_size = 100, x_min = x_min, x_max = x_max, sigma = 0.25)

## create grid for plotting
x_grid = data.frame(x = seq(x_min - 0.5, x_max + 0.5, 0.001))
