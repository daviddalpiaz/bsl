...
- Restart R. In RStudio, use `Session > Restart R`. (Restarting RStudio will accomplish this if you aren't restoring your workspace.)
...
- If you see the name of another package in an error message, try installing that package, then retry installing the original package. You may need to repeat this process.
